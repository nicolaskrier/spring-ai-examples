...
class MistralAiApiExample {
    ...
    MistralAiApi mistralAiApi() {
        ...
        return MistralAiApi.builder().apiKey(mistralAiApiKey).baseUrl("https://api.eu.mistral.ai").build();
    }
    ...
    ApplicationRunner applicationRunner(MistralAiApi mistralAiApi) {
        return _ -> {
            ...
            var userChatCompletionMessage = new MistralAiApi.ChatCompletionMessage(
                    "Who is the current pope? Roman numbers could be used if necessary.",
                    USER
            );
            ...
            LOGGER.info("The current pope is '{}'.", chatCompletionMessageContent);
        };
    }
