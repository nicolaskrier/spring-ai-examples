    ...
    ApplicationRunner applicationRunner(OllamaApi ollamaApi) {
        return _ -> {
            ...
            var userRequestMessage = OllamaApi.Message.builder(USER)
                    .content("Who is the current pope? Roman numbers could be used if necessary.")
                    .build();
            var chatRequest = OllamaApi.ChatRequest.builder("ministral-3:14b")
            ...
            LOGGER.info("The current pope is '{}'.", responseMessageContent);
        };
    }
